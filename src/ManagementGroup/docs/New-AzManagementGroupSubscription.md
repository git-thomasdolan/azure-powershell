...
online version: https://docs.microsoft.com/powershell/module/az.managementgroup/new-azmanagementgroupsubscription
schema: 2.0.0
---
...
```
New-AzManagementGroupSubscription -InputObject <IManagementGroupIdentity> [-DefaultProfile <PSObject>]
