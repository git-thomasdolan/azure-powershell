...
online version: https://docs.microsoft.com/powershell/module/az.managementgroup/get-azmanagementgroupdescendant
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzManagementGroupDescendant -InputObject <IManagementGroupIdentity> [-Skiptoken <String>] [-Top <Int32>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.ManagementGroup.Models.Api20210401.IDescendantInfo
